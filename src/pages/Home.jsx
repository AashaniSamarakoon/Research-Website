...
export default function Home() {
  ...
  const filteredDocs = useMemo(() => {
    const isPresentation = (d) => d.badge === "Presentation";
    const base = documents.filter((d) => !isPresentation(d));

    if (activeTab === "all") return base;
    return base.filter((d) => d.category === activeTab);
  }, [activeTab]);

  const presentationDocs = useMemo(
    () => documents.filter((d) => d.badge === "Presentation"),
    [],
  );
  ...
  return (
    <main>
      ...
      {/* DOMAIN */}
      <section id="domain" className="bg-slate-950/20 py-20">
        <SectionHeader
          label="Domain"
          title="Domain Overview"
          sub="A concise summary of the literature, gap, problem, objectives, methodology, and technologies used."
        />

        <div className="mx-auto mt-12 grid max-w-6xl grid-cols-1 gap-6 px-6 md:grid-cols-2">
          <Card title="Literature Survey">{domain.literatureSurvey}</Card>
          <Card title="Research Gap">{domain.researchGap}</Card>
          <Card title="Research Problem">{domain.researchProblem}</Card>
          <Card title="Research Objectives">
            <ul className="mt-1 space-y-2">
              {domain.researchObjectives.map((o) => (
        ...
        <div className="mx-auto mt-8 max-w-6xl px-6">
          <div className="grid grid-cols-1 gap-6 md:grid-cols-2">
            <Card title="Methodology">{domain.methodologyNote}</Card>
            <Card title="Technologies Used">
              <div className="mt-1 flex flex-wrap gap-2">
                {domain.technologiesUsed.map((t) => (
              ...
              <div className="mt-4 flex flex-wrap gap-3">
                <a
                  href="#methodology"
                  className="inline-flex items-center rounded-lg border border-white/10 bg-white/5 px-4 py-2 text-xs font-semibold text-slate-50 hover:bg-white/10"
                >
                  View Methodology Section
                </a>
                <a
                  href="#documents"
                  className="inline-flex items-center rounded-lg border border-white/10 bg-white/5 px-4 py-2 text-xs font-semibold text-slate-50 hover:bg-white/10"
          ...
          <div className="rounded-2xl border border-white/10 bg-white/5 p-7">
            ...
            <div className="mt-6 space-y-4">
              ...
              <div>
                ...
                <div className="mt-2 h-2 rounded-full bg-white/10">
                  <div className="h-2 w-[88%] rounded-full bg-secondary" />
                </div>
              </div>
            </div>
          </div>
      ...
      {/* MILESTONES */}
      <section id="milestones" className="bg-slate-950/20 py-20">
        <SectionHeader
          label="Project Assessments"
          title="Milestones"
          sub="Select an assessment to view its description, date, and mark allocation. Update dates/marks in the content file when confirmed."
        />
          ...
          <div className="rounded-2xl border border-white/10 bg-white/5 p-6">
            <label className="text-xs font-semibold uppercase tracking-[0.16em] text-slate-400">
              ...
              <select
                ...
                className="mt-3 w-full rounded-xl border border-white/10 bg-slate-950/30 px-4 py-3 text-sm text-slate-100 outline-none focus:border-secondary/50"
              >
                {milestones.map((m) => (
              ...
              <div className="mt-6 grid grid-cols-1 gap-6 md:grid-cols-3">
                ...
                <div className="space-y-3">
                  ...
                  <div className="rounded-2xl border border-white/10 bg-slate-950/30 p-4">
                    ...
                    <div className="mt-1 inline-flex items-center rounded-full border border-secondary/30 bg-secondary/10 px-3 py-1 text-[11px] font-semibold uppercase tracking-[0.16em] text-secondary">
      ...
      <section id="documents" className="bg-slate-950/20 py-20">
        <SectionHeader
          ...
          sub="TAF, proposals, reports, and the research paper draft. Presentation slides are listed separately under Slides."
        />
      ...
      {/* SLIDES */}
      <section id="slides" className="bg-primary py-20">
        <SectionHeader
          label="Presentations"
          title="Slides of Past Presentations"
          sub="Slides used for proposal and progress presentations. Add new PDFs to the Presentation slides folder to include future presentations."
        />

        <div className="mx-auto mt-10 max-w-6xl px-6">
          <div className="space-y-3">
            {presentationDocs.map((d) => (
              <div
                key={d.id}
                className="flex flex-col gap-3 rounded-2xl border border-white/10 bg-white/5 p-5 hover:bg-white/10 sm:flex-row sm:items-center"
              >
          ...
          <Card title="Email Template">
            <a
              ...
              href={`mailto:${contact.generalEmail}?subject=${encodeURIComponent(
                "FreshRoute research inquiry",
              )}&body=${encodeURIComponent(
                "Hello FreshRoute team,%0D%0A%0D%0AI am reaching out regarding...%0D%0A%0D%0AName:%0D%0AOrganization:%0D%0AContact number:%0D%0A",
              )}`}
            >
